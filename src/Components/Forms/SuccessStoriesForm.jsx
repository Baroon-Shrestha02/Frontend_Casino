...
export default function SuccessStoriesForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Axios POST request
      const response = await api.post("/success-stories/add", formDataToSend, {
        headers: {
      ...
      setErrors({
        submit:
          ...
          "Failed to submit success story. Please try again.",
      });
    } finally {
    ...
    <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white max-w-7xl mx-auto rounded-3xl py-12 px-4 sm:px-6 lg:px-8 my-8 shadow-2xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div className="flex items-center flex-col justify-center gap-6 text-center lg:text-left px-4">
          ...
          >
            Inspire others by sharing your journey and achievements. Your
            success story can motivate the next generation of professionals.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="space-y-5">
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <label className="flex-1 cursor-pointer">
                  <div
                    className={`w-full px-4 py-3 border-2 rounded-xl transition-all text-gray-900 ${
                      errors.posterImage ? "border-red-500" : "border-gray-200"
                    } hover:border-blue-400 flex items-center justify-center`}
                  >
                    <span className="text-gray-600">
                      {formData.posterImage
                        ? formData.posterImage.name
                        : "Choose poster image..."}
                    </span>
                  </div>
                  <input
                ...
                {posterImagePreview && (
                  ...
                  >
                    <img
                      ...
                      alt="Preview"
                      className="w-20 h-20 rounded-lg object-cover border-2 border-gray-200 aspect-[4/3]"
                    />
                    <button
                      type="button"
                      onClick={() => {
            ...
            <motion.button
              ...
              transition={{ duration: 0.2 }}
              className={`w-full bg-primary text-white py-4 rounded-xl font-semibold text-lg shadow-lg ${
                isSubmitting
